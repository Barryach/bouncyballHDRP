...
public class TutorialStep7 : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player") && !isTyping) // Evita que se active mientras se escribe
        {
            ...
            string message = "¡Cuidado con las estalactitas! Esquivalas o morirás. Además, asegúrate de no tocar el techo para evitar daños. Presiona ENTER para continuar.";
