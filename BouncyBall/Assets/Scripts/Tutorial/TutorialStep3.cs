...
public class TutorialStep3 : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player") && !isTyping) // Evita que se active mientras se escribe
        {
            ...
            string message = "¡Atención! Hay saltos más grandes de lo normal en el camino. Solo podrás saltarlos si te transformas en la pelota de playa, ya que es más ágil y ligera. ¡Prepárate para saltar más alto!";
